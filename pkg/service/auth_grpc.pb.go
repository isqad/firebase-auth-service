...
func (c *authClient) Verify(ctx context.Context, in *Token, opts ...grpc.CallOption) (*Token, error) {
	out := new(Token)
...
func (UnimplementedAuthServer) Verify(context.Context, *Token) (*Token, error) {
